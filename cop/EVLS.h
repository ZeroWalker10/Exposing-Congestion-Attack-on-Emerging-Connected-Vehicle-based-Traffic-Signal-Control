...
extern void EVLS(int phase_est, long current_time, float red_elapse_time, int No_lanes);    //phase_est is the current estimated phase
...
void EVLS(int phase_est, long current_time, float red_elapse_time, int No_lanes)
{
	...
	sprintf(temp_log,"Current time is: %ld\n",current_time);
	outputlog(temp_log);cout<<temp_log;
